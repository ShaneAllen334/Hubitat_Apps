...
def finalizeScan() {
    ...
    state.cachedTelemetry = getHubTelemetry()
...
def serveJsonEndpoint() {
    try {
        ...
        def payload = [
            ...
            telemetry: state.cachedTelemetry ?: [memoryTotal: "Unknown", memoryFree: "Unknown", dbSize: "Unknown", uptime: "Unknown", firmware: "Unknown"],
